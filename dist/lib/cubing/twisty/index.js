    ...
    this.#freshListenerManager.addListener(
      ...
      async (scheme) => {
        ...
        if ("experimentalUpdateCubeColorScheme" in twisty3D) {
          twisty3D.experimentalUpdateCubeColorScheme(scheme);
          this.scheduleRender();
        }
      }
    );
...
// src/cubing/twisty/model/props/puzzle/display/ExperimentalCubeColorsProp.ts
function resolveCubeColors(input) {
  return resolveCubeColorScheme(
    input
  );
}
var ExperimentalCubeColorsProp = class extends TwistyPropSource {
  getDefaultValue() {
    return void 0;
  }
  derive(input) {
...
var twistyPlayerAttributeMap = {
  ...
  "experimental-cube-color-scheme": "experimentalCubeColorScheme",
...
var TwistyPlayer = class extends TwistyPlayerSettable {
  ...
  constructor(config = {}) {
    ...
    for (const [propName, value] of Object.entries(config)) {
      ...
      if (propName === "experimentalCubeColorScheme" && config.experimentalCubeColors !== void 0) {
        continue;
      }
      this[propName] = value;
    }
...
var TwistyAlgViewer = class extends ManagedCustomElement {
