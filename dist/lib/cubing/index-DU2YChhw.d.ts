...
type ResolvedCubeColorScheme = Record<CubeFace, CubeColor>;
declare class ExperimentalCubeColorSchemeProp extends TwistyPropSource<ResolvedCubeColorScheme, ExperimentalCubeColorScheme> {
  getDefaultValue(): ResolvedCubeColorScheme;
  protected derive(input: ExperimentalCubeColorScheme): ResolvedCubeColorScheme;
}
//#endregion
...
declare class TwistySceneModel {
  ...
  experimentalCubeColorScheme: ExperimentalCubeColorSchemeProp;
...
//#endregion
export { PGNotation as $, CubeFace as A, AlgNode as At, NO_VALUE as B, Commutator as Bt, VisualizationFormat as C, experimentalAppendMove as Ct, PuzzleID as D, Unit as Dt, ExperimentalStickering as E, SimplifyOptions as Et, TreeAlgIndexer as F, Pause as Ft, KPuzzle as G, MillisecondTimestamp as H, ExperimentalSerializationOptions as Ht, SimpleAlgIndexer as I, Move as It, KPatternData as J, KTransformation as K, AlgIndexer as L, MoveModifications as Lt, ExperimentalCubeColorScheme as M, LineComment as Mt, ResolvedCubeColorScheme as N, Grouping as Nt, CUBE_FACES as O, AlgBranch as Ot, setTwistyDebug as P, GroupingModifications as Pt, KTransformationOrbitData as Q, LeafCount as R, QuantumMove as Rt, TwistyAnimatedSVG as S, Alg as St, backViewLayouts as T, PuzzleSpecificSimplifyOptions as Tt, schreierSims as U, MillisecondDuration as V, ExperimentalNotationType as Vt, KPattern as W, KPuzzleOrbitDefinition as X, KPatternOrbitData as Y, KTransformationData as Z, cube2x2x2 as _, PuzzleGeometryOptions as _t, functionFromTraversal as a, PuzzleDescription as at, wcaEventInfo as b, setAlgDebug as bt, PuzzleLoader as c, StickerDatAxis as ct, TwistyAlgEditor as d, getPG3DNamedPuzzles as dt, PUZZLE_BASE_SHAPES as et, Parsed as f, getPuzzleDescriptionString as ft, cube3x3x3 as g, Quat as gt, puzzles as h, parsePuzzleDescription as ht, TraversalUp as i, PuzzleCutType as it, CustomCubeColorScheme as j, Newline as jt, CubeColor as k, AlgLeaf as kt, TwizzleLink as l, StickerDatFace as lt, TwistyPlayerConfig as m, getPuzzleGeometryByName as mt, experimentalAlgCubingNetLink as n, PuzzleBaseShape as nt, keyToMove as o, PuzzleGeometry as ot, TwistyPlayer as p, getPuzzleGeometryByDesc as pt, KPuzzleDefinition as q, TraversalDownUp as r, PuzzleCutDescription as rt, KeyMapping as s, StickerDat as st, AlgCubingNetOptions as t, PUZZLE_CUT_TYPES as tt, TwistyAlgViewer as u, StickerDatSticker as ut, eventInfo as v, experimentalIs as vt, BackViewLayout as w, AppendCancelOptions as wt, wcaEvents as x, AlgBuilder as xt, twizzleEvents as y, Example as yt, LeafIndex as z, Conjugate as zt };