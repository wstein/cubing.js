...
//#endregion
//#region src/cubing/twisty/model/props/puzzle/display/ExperimentalCubeColorSchemeProp.d.ts
declare const CUBE_FACES: readonly ["U", "L", "F", "R", "B", "D"];
type CubeFace = (typeof CUBE_FACES)[number];
type CubeColor = string | number;
type CustomCubeColorScheme = Partial<Record<CubeFace, CubeColor>>;
...
type ExperimentalCubeColorScheme = CubeColorSchemePreset | CustomCubeColorScheme | SerializedCubeColorScheme;
type ResolvedCubeColorScheme = Readonly<Record<CubeFace, CubeColor>>;
//#endregion
//#region src/cubing/twisty/model/props/puzzle/display/ExperimentalCubeColorsProp.d.ts
type CubeColorPreset = "boy" | "western" | "japanese" | "default";
/** Cube face colors for the 3D renderers. */
type ExperimentalCubeColors = CubeColorPreset | CustomCubeColorScheme | (string & {});
declare function resolveCubeColors(input: ExperimentalCubeColors | undefined): Readonly<Record<"U" | "L" | "F" | "R" | "B" | "D", CubeColor>> | undefined;
declare class ExperimentalCubeColorsProp extends TwistyPropSource<ReturnType<typeof resolveCubeColors>, ExperimentalCubeColors | undefined> {
  getDefaultValue(): undefined;
  protected derive(input: ExperimentalCubeColors | undefined): Readonly<Record<"U" | "L" | "F" | "R" | "B" | "D", CubeColor>> | undefined;
}
//#endregion
...
declare class TwistySceneModel {
  ...
  experimentalCubeColors: ExperimentalCubeColorsProp;
  /** @deprecated Alias of `experimentalCubeColors`; both share one source. */
  experimentalCubeColorScheme: ExperimentalCubeColorsProp;
...
declare abstract class TwistyPlayerSettable extends ManagedCustomElement {
  ...
  /**
   * @deprecated Use `experimentalCubeColors`. Both names set the same value,
   * so the most recent assignment wins.
   */
  set experimentalCubeColorScheme(scheme: ExperimentalCubeColorScheme | undefined);
...
declare class TwistyAlgLeafElem extends HTMLElementShim {
...
/** @category Other Custom Elements */
declare class TwistyAlgViewer extends ManagedCustomElement {
  #private;
...
//#endregion
export { KTransformationData as $, CUBE_FACES as A, AlgBranch as At, LeafCount as B, QuantumMove as Bt, VisualizationFormat as C, AlgBuilder as Ct, PuzzleID as D, PuzzleSpecificSimplifyOptions as Dt, ExperimentalStickering as E, AppendCancelOptions as Et, ResolvedCubeColorScheme as F, Grouping as Ft, schreierSims as G, NO_VALUE as H, Commutator as Ht, setTwistyDebug as I, GroupingModifications as It, KTransformation as J, KPattern as K, TreeAlgIndexer as L, Pause as Lt, CubeFace as M, AlgNode as Mt, CustomCubeColorScheme as N, Newline as Nt, CubeColorPreset as O, SimplifyOptions as Ot, ExperimentalCubeColorScheme as P, LineComment as Pt, KPuzzleOrbitDefinition as Q, SimpleAlgIndexer as R, Move as Rt, TwistyAnimatedSVG as S, setAlgDebug as St, backViewLayouts as T, experimentalAppendMove as Tt, MillisecondDuration as U, ExperimentalNotationType as Ut, LeafIndex as V, Conjugate as Vt, MillisecondTimestamp as W, ExperimentalSerializationOptions as Wt, KPatternData as X, KPuzzleDefinition as Y, KPatternOrbitData as Z, cube2x2x2 as _, parsePuzzleDescription as _t, functionFromTraversal as a, PuzzleCutDescription as at, wcaEventInfo as b, experimentalIs as bt, PuzzleLoader as c, PuzzleGeometry as ct, TwistyAlgEditor as d, StickerDatFace as dt, KTransformationOrbitData as et, Parsed as f, StickerDatSticker as ft, cube3x3x3 as g, getPuzzleGeometryByName as gt, puzzles as h, getPuzzleGeometryByDesc as ht, TraversalUp as i, PuzzleBaseShape as it, CubeColor as j, AlgLeaf as jt, ExperimentalCubeColors as k, Unit as kt, TwizzleLink as l, StickerDat as lt, TwistyPlayerConfig as m, getPuzzleDescriptionString as mt, experimentalAlgCubingNetLink as n, PUZZLE_BASE_SHAPES as nt, keyToMove as o, PuzzleCutType as ot, TwistyPlayer as p, getPG3DNamedPuzzles as pt, KPuzzle as q, TraversalDownUp as r, PUZZLE_CUT_TYPES as rt, KeyMapping as s, PuzzleDescription as st, AlgCubingNetOptions as t, PGNotation as tt, TwistyAlgViewer as u, StickerDatAxis as ut, eventInfo as v, Quat as vt, BackViewLayout as w, Alg as wt, wcaEvents as x, Example as xt, twizzleEvents as y, PuzzleGeometryOptions as yt, AlgIndexer as z, MoveModifications as zt };